            ...
            render: (_, record) => (
                <div className="flex justify-start items-center gap-2">
                    <img
                        ...
                        src={generateImage(record?.user?.image) || 'https://via.placeholder.com/150'}
    ...
    return (
        ...
        >
            <div className="mb-6 flex justify-between items-center">
                ...
                <div className="flex justify-end items-center gap-3">
                    ...
                    value={filters?.search}
                        ...
                        suffix={<IoClose onClick={() => handleSearch('')} size={14} color="#2B2A2A" />}
                        style={{
                            width: '300px',
                            height: '39px',
                            fontSize: '14px',
            ...
            >
                {selectedRecord && (
                    <div className="p-6">
                        <h2 className="text-[#F27405] text-lg mb-4">
                            Transaction Details
                        </h2>
                        <p>
                            <strong>User:</strong>{' '}
                            {selectedRecord.user?.name || 'Unknown'}
                        </p>
                        <p>
                            <strong>Salon:</strong>{' '}
                            {selectedRecord.salon?.name || 'Unknown'}
                        </p>
                        <p>
                            <strong>Service:</strong>{' '}
                            {selectedRecord.service?.name || 'N/A'}
                        </p>
                        <p>
